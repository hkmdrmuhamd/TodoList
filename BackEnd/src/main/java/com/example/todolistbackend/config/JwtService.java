...
public class JwtService {
    ...
    private static final String SECRET_KEY = "5EToCDw5yBWZLblPu5fFAM3e+E/V4MVjL/gZi6VFNPlauYOXGx/MyoxNxZrfUT6c";
    ...
    public String generateToken( // Token yaratma işlemi gerçekleştiriliyor.
